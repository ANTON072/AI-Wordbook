...
PRD(docs/001_product-requirements.md)と機能設計書(docs/002_functional-design.md)をもとに技術仕様書(docs/003_architecture.md)を作成する。
...
- `docs/001_product-requirements.md` と `docs/002_functional-design.md` を読む。**PRDと機能設計書は確定した正とし、その内容は疑わない。**
...
`docs/003_architecture.md` の内容を読み、その全文を添えて `architecture-reviewer` エージェントにレビューを依頼する。
