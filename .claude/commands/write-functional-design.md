...
PRD(docs/spec/001_product-requirements.md)をもとに機能設計書(docs/spec/002_functional-design.md)を作成する。
...
- `docs/spec/001_product-requirements.md` を読む。**PRDは確定した正とし、その内容は疑わない。**
...
`docs/spec/002_functional-design.md` の内容を読み、その全文を添えて `functional-design-reviewer` エージェントにレビューを依頼する。
